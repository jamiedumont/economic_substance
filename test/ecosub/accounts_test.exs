defmodule EcoSub.AccountsTest do
  use EcoSub.DataCase

  alias EcoSub.Accounts

  import EcoSub.AccountsFixtures
  alias EcoSub.Accounts.{User, UserToken}
  ...
  describe "profiles" do
    ...
    @invalid_attrs %{contact_code: nil, primary: nil}
    ...
    test "create_profile/1 with valid data creates a profile" do
      valid_attrs = %{contact_code: "some contact_code", primary: true}

      assert {:ok, %Profile{} = profile} = Accounts.create_profile(valid_attrs)
      assert profile.contact_code == "some contact_code"
      assert profile.primary == true
    end
    ...
    test "update_profile/2 with valid data updates the profile" do
      profile = profile_fixture()
      update_attrs = %{contact_code: "some updated contact_code", primary: false}

      assert {:ok, %Profile{} = profile} = Accounts.update_profile(profile, update_attrs)
      assert profile.contact_code == "some updated contact_code"
      assert profile.primary == false
    end
